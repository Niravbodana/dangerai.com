      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="mb-8 flex items-end justify-between gap-4">
          ...
          <Link
            ...
            className="hidden items-center gap-1.5 text-sm font-medium text-[var(--accent-soft)] transition hover:underline sm:flex"
          >
            {t('viewAll')}
        ...
        <Link
          to="/recipes?sort=trending"
          className="mt-6 flex items-center justify-center gap-1.5 text-sm font-medium text-[var(--accent-soft)] sm:hidden"
        >
          {t('viewAll')}
          <IconArrowRight className="w-4 h-4" />
        </Link>
