...
export const REGISTERED_DATASETS = {
  ...
  "themealdb-seed": {
    id: "themealdb-seed",
    name: "TheMealDB metadata seed (free API)",
    sourceUrl: "https://www.themealdb.com/api.php",
    licenseSpdx: "RASOIRA-AI",
    commercialUseAllowed: true,
    attributionRequired: false,
    allowedFields: ["recipe_seed", "image"],
    robotsTxtRespected: true,
    apiCommercialUse: true,
    notes: "Dish metadata + photo seed only; instructions regenerated as original Rasoira content.",
  },
  "spoonacular-seed": {
    id: "spoonacular-seed",
    name: "Spoonacular metadata seed",
    ...
    robotsTxtRespected: true,
    apiCommercialUse: true,
    notes: "Requires SPOONACULAR_API_KEY; original content generated from metadata.",
  },
  "pexels-images": {
    id: "pexels-images",
    name: "Pexels HD food photos",
    ...
    robotsTxtRespected: true,
    apiCommercialUse: true,
    notes: "Requires PEXELS_API_KEY (free).",
  },
  "unsplash-images": {
    id: "unsplash-images",
    name: "Unsplash HD food photos",
    ...
    robotsTxtRespected: true,
    apiCommercialUse: true,
    notes: "Requires UNSPLASH_ACCESS_KEY (free).",
  },
  "pixabay-images": {
    id: "pixabay-images",
    name: "Pixabay HD food photos",
    ...
    robotsTxtRespected: true,
    apiCommercialUse: true,
    notes: "Requires PIXABAY_API_KEY (free).",
  },
};
